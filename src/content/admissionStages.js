export const groupStages = [
    ...
    children: [
      {
        ...
        description: 'Please enter your personal information and proceed to the next step.',
      ...
      },
      {
        ...
        description: 'Please enter your family background and proceed to the next step.',
    ...
    children: [
      {
        ...
        overview: 'The school provides students with an outstanding curriculum that effectively meets their needs and aspirations. So to be able to update your record correctly we will need to get your previous Educational background and other supporting documents.'
      },
      {
        id: 6,
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 8,
        subHeader: 'Enlistment Status',
        image: '/img/svg/student-webinar.svg',
        description: 'A few more steps and you\'re done. We will just need to validate your requirements and your application for the current academic year.',
        overview: 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est.'
      }
    ]
  },
